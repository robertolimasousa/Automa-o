...
<div class="ai-assistant">
    ...
    <!-- 🔘 BOTÃO MENOR E MAIS PREMIUM -->
    <button class="ai-button" onclick="toggleAI()">
        ✦
    </button>
...
.ai-button::before{{
    ...
    animation:shineAI 5s linear infinite;
}}
...
.ai-button:hover{{
    ...
    0 0 45px rgba(0,234,255,.9),
    0 0 80px rgba(0,102,255,.45);
}}
...
function drag(e){{
    ...
    const maxX = window.innerWidth - aiButton.offsetWidth;
    const maxY = window.innerHeight - aiButton.offsetHeight;
...
function stopDrag(){{
    ...
    aiButton.style.transition = ".25s ease";
}}
...
/* efeito neon verde bebê no hover */
.btn:hover {
